...
class Human : CharacterRace() {
	...
	override val RacialTraits: List<RacialTraits> = listOf(
		RacialTraits(
			"Extra Feat",
			"Extra feat at 1st level, because humans are quick to master specialized tasks and varied in their talents."
		),
		RacialTraits(
			"Extra Skillpoints",
	...
	override val Vision: Vision = de.buadrabas.dnd_companion.data.races.Vision.NORMAL_VISION
	override val RaceName: String = "Human"
